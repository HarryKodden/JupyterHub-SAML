...
#HKc.JupyterHub.authenticator_class = 'oauthenticator.GitHubOAuthenticator'
#HKc.GitHubOAuthenticator.client_id = OAUTH_CLIENT_ID
#HKc.GitHubOAuthenticator.client_secret = OAUTH_CLIENT_SECRET
#HKc.GitHubOAuthenticator.oauth_callback_url = OAUTH_CALLBACK_URL
